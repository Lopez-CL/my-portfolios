...
const Resume = () => {
    return (
        <div id="resume-container">
            ...
            <div>
                <h4 className="position">Front-End Developer & UX Designer | University of California San Diego | San Diego, CA (2024-Present)</h4>
                <ul className="responsibilities" >
                    <li>Collaborating with key stakeholders, including student UX designers and the UX lead, to create user-centered digital experiences.</li>
                    <li>Mentoring student UX designers in a team-based approach to achieving frontend solutions.</li>
                    <li>Leveraging JavaScript, CSS, PHP, Velocity and HTML expertise to develop accessible, responsive solutions in platforms like Primo VE/Alma, Cascade CMS, and Springshare's LibApps suite.
                    </li>
                    <li>Translating complex Figma wireframes into functional, documented code.
                    </li>
                    ...
                    <li>Bridging the worlds of design and development by crafting creative, innovative solutions that elevate the Library's digital presence.</li>
                </ul>
            </div>
            <div>
                ...
                <ul className="responsibilities" >
                    ...
                    <li>Lead designer and strategist for Library Instagram, <a id="IG-Link" href="https://www.instagram.com/bmcclibrary/" rel="noreferrer" target="_blank">@bmcclibrary</a>.</li>
                </ul>
            </div>
            <div>
